...
const Menu = ({ openModal, updateCartCount, addToCart }) => {
  ...
  return (
    <div className="menu-container flex bg-white pt-24"> {/* Added pt-24 for top padding */}
      {/* Sidebar */}
      <div className="w-1/4 bg-gray-100 p-4 border-r fixed left-0 top-24 bottom-0 overflow-y-auto">
      ...
      {/* Main content */}
      <div className="w-3/4 p-8 ml-1/4"> {/* Added ml-1/4 to offset the fixed sidebar */}
