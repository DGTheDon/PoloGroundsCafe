        ...
        <div className="flex items-center">
          ...
          <Link to="/" className="mr-8">
            <div className="h-12 w-12 bg-gray-200 flex items-center justify-center">
              ...
              <img src="/Users/donaldgibson/PoloGroundsCafe/polo-grounds-cafe/src/components/pologroundscafelogo.png" alt="Polo Grounds Cafe Logo" className="max-h-full max-w-full" />
            </div>
          </Link>
