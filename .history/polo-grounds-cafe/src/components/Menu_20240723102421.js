...
const Menu = ({ openModal, updateCartCount, addToCart }) => {
  ...
  return (
    <div className="menu-container flex bg-white pt-16"> {/* Adjusted pt-16 for header height */}
      {/* Sidebar */}
      <div className="w-1/4 bg-gray-100 p-4 border-r h-screen overflow-y-auto fixed left-0 top-16"> {/* Adjusted top-16 */}
      ...
      {/* Main content */}
      <div className="w-3/4 p-8 ml-1/4 min-h-screen"> {/* Added min-h-screen */}
