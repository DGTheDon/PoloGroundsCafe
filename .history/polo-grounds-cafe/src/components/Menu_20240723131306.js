...
const menuItems = [
  ...
  { id: 2, name: 'Hot Coffee', price: 3.50, category: 'Drinks', subCategory: 'Hot Coffees', image: '/path/to/hot-coffee-image.jpg' },
  { id: 3, name: 'Cold Brew', price: 4.00, category: 'Drinks', subCategory: 'Cold Coffees', image: '/path/to/cold-brew-image.jpg' },
  { id: 4, name: 'Polo Grounds Refresher', price: 4.50, category: 'Drinks', subCategory: 'Polo Grounds Refreshers™', image: '/path/to/refresher-image.jpg' },
  { id: 5, name: 'Iced Tea', price: 3.00, category: 'Drinks', subCategory: 'Iced Teas', image: '/path/to/iced-tea-image.jpg' },
  { id: 6, name: 'Hot Tea', price: 2.50, category: 'Drinks', subCategory: 'Hot Teas', image: '/path/to/hot-tea-image.jpg' },
  { id: 7, name: 'Frappuccino', price: 5.00, category: 'Drinks', subCategory: 'Frappuccino® Blended Beverages', image: '/path/to/frappuccino-image.jpg' },
...
const Menu = ({ openModal, updateCartCount, addToCart }) => {
  ...
  return (
    <div className="menu-container flex bg-white pt-16">
      {/* Sidebar */}
      <div className="w-1/4 bg-gray-100 p-4 border-r h-screen overflow-y-auto sticky top-16">
